...
Source0  : https://github.com/cea-hpc/modules/releases/download/v4.7.1/modules-4.7.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624408143
...
cp %{_builddir}/modules-4.7.1/COPYING.GPLv2 %{buildroot}/usr/share/package-licenses/modules/db95910cb27890d60e596e4c622fc3eeba6693fa
cp %{_builddir}/modules-4.7.1/compat/LICENSE.GPL %{buildroot}/usr/share/package-licenses/modules/db95910cb27890d60e596e4c622fc3eeba6693fa
%make_install
...
/usr/share/doc/environment-modules/INSTALL-win.txt
